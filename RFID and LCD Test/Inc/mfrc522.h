 ...
 *      Author: Alex Wilson
 *
 *  This is highly based on another users code TILZoR
 *  you can find his original version at this link
...
uint8_t txbuff[MFRC522_MAX_LEN];
uint8_t rxbuff[MFRC522_MAX_LEN];
